		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-lg-12">
				<div class="box box-warning">
					...
					?>
							<div class="box-body">
								<form role="form" action="alteraproduto" method="post" class="form-horizontal">
									<div class="box-body">
										<div class="form-group">
											<label for="descricaoproduto" class="col-sm-2 control-label">ID do Produto</label>

											<div class="col-sm-10">
												<input type="text" class="form-control" id="produtoid" name="produtoid" value="<?= $prod->id; ?>" readonly="readonly">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" id="descricaoproduto" name="descricaoproduto" placeholder="Informe a descrição do produto" value="<?= $prod->descricaoproduto; ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-10">
												<select class="form-control" id="unidade" name="unidade">
													...
													<option value="1" <?php if ((int)$prod->unidade === 1) {
																	echo 'selected="selected"';
																} ?>>Unidade</option>
													<option value="2" <?php if ((int)$prod->unidade === 2) {
																	echo 'selected="selected"';
																} ?>>Caixa</option>
													<option value="3" <?php if ((int)$prod->unidade === 3) {
																	echo 'selected="selected"';
																} ?>>Kilo</option>
													<option value="4" <?php if ((int)$prod->unidade === 4) {
																	echo 'selected="selected"';
																} ?>>Metro</option>
												</select>
											</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" id="valormercadoria" name="valormercadoria" placeholder="Informe o valor da mercadoria" value="<?= $prod->valormercadoria; ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" id="valorvenda" name="valorvenda" placeholder="Informe o valor para venda" value="<?= $prod->valorvenda; ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" id="qtdeestoque" name="qtdeestoque" placeholder="Informe a quantidade em Estoque" value="<?= $prod->qtdeestoque; ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" id="descontopermitido" name="descontopermitido" placeholder="Informe o valor máximo de desconto permitido" value="<?= $prod->descontopermitido; ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" id="alertaestoque" name="alertaestoque" placeholder="Informe o estoque minimo para alerta do sistema" value="<?= $prod->alertaestoque; ?>">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-sm-10">
												<input type="text" class="form-control" id="qtdevendaminima" name="qtdevendaminima" placeholder="Informe a quantidade minima para venda" value="<?= $prod->qtdevendaminima; ?>">
											</div>
										</div>
										<div class="form-group">
